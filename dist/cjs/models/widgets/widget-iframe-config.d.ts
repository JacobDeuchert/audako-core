 ...
 */
export declare enum PermissionsPolicyAllowList {
    STAR = "*",
    SELF = "self",
    SRC = "src",
    NONE = "none",
 ...
 */
export declare enum IframeLoadingMethods {
    LAZY = "lazy",
    EAGER = "eager",
    AUTO = "auto"
}
export declare const WidgetIframeVersion: string;
export declare class WidgetIframeConfig extends BaseWidgetConfig {
    /**
